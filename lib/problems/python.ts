...
export const pythonProblems: Problem[] = [
  ...
  },
  {
    ...
    difficulty: 'medium',
    title: 'Zip Two Lists',
    text: 'Combine two lists into a list of tuples using zip',
    ...
    hints: ['Use zip() to combine iterables element by element'],
    validPatterns: [
  ...
  },
  {
    ...
    text: 'Create a list of tuples with (index, value) pairs using enumerate',
    ...
    hints: ['Use enumerate() to get index and value pairs'],
    validPatterns: [
  ...
  },
  {
    ...
    text: 'Get all key-value pairs as a list of tuples',
    setup: 'person = {"name": "Alice", "age": 30}',
    setupCode: 'person = {"name": "Alice", "age": 30}',
    expected: [['name', 'Alice'], ['age', 30]],
    sample: 'list(person.items())',
    hints: ['Use the items() method and convert to list'],
    validPatterns: [
