...
export const luaProblems: Problem[] = [
  ...
  },
  {
    ...
    setupCode: 'local people = {{name="Bob", age=30}, {name="Alice", age=25}, {name="Carol", age=35}}',
    expected: [{name: 'Alice', age: 25}, {name: 'Bob', age: 30}, {name: 'Carol', age: 35}],
  ...
  },
  {
    ...
    expected: [1, 2, 3, 4],
    sample: 'local seen = {}; local result = {}; for _, v in ipairs(nums) do if not seen[v] then seen[v] = true; table.insert(result, v) end end; return result',
  ...
  },
  {
    ...
    expected: 4,
    sample: 'local count = 0; for _, v in ipairs(nums) do if v == 5 then count = count + 1 end end; return count',
  ...
  },
  {
    ...
    expected: [1, 2, 3, 4, 5, 6],
    sample: 'local result = {}; for _, inner in ipairs(nested) do for _, v in ipairs(inner) do table.insert(result, v) end end; return result',
  ...
  },
  {
    ...
    sample: 'local result = {}; for i = 1, #keys do result[i] = {keys[i], vals[i]} end; return result',
  ...
  },
  {
    ...
    expected: {x: [{name: 'a', cat: 'x'}, {name: 'c', cat: 'x'}], y: [{name: 'b', cat: 'y'}]},
    sample: 'local groups = {}; for _, item in ipairs(items) do groups[item.cat] = groups[item.cat] or {}; table.insert(groups[item.cat], item) end; return groups',
  ...
  },
  {
    ...
    expected: ['a', 'b', 'c'],
    sample: 'local keys = {}; for k in pairs(info) do table.insert(keys, k) end; table.sort(keys); return keys',
  ...
  },
  {
    ...
    setupCode: 'local scores = {alice = 90, bob = 85, carol = 95}',
    expected: [85, 90, 95],
    sample: 'local vals = {}; for _, v in pairs(scores) do table.insert(vals, v) end; table.sort(vals); return vals',
  ...
  },
  {
    ...
    sample: 'local function deepcopy(t) local copy = {}; for k, v in pairs(t) do if type(v) == "table" then copy[k] = deepcopy(v) else copy[k] = v end end; return copy end; return deepcopy(orig)',
  ...
  },
  {
    ...
    expected: [1, 3, 5],
    sample: 'local set = {}; for _, v in ipairs(b) do set[v] = true end; local result = {}; for _, v in ipairs(a) do if not set[v] then table.insert(result, v) end end; return result',
  ...
  },
  {
    ...
    expected: [3, 4],
    sample: 'local set = {}; for _, v in ipairs(a) do set[v] = true end; local result = {}; for _, v in ipairs(b) do if set[v] then table.insert(result, v) end end; return result',
  ...
  },
  {
    ...
    expected: 12,
    sample: 'local pos = 0; local i = 1; while true do local p = string.find(s, " ", i, true); if not p then break end; pos = p; i = p + 1 end; return pos',
  ...
  },
  {
    ...
    expected: 3,
    sample: 'local count = 0; for _ in string.gmatch(s, "a") do count = count + 1 end; return count',
  ...
  },
  {
    ...
    expected: ['a', 'b', 'c', 'd'],
    sample: 'local result = {}; for part in string.gmatch(s, "[^,]+") do table.insert(result, part) end; return result',
  ...
  },
  {
    ...
    setupCode: 'local s = "hello world lua"',
    expected: 'Hello World Lua',
    sample: 'return (string.gsub(s, "(%a)([%a]*)", function(a, b) return string.upper(a) .. string.lower(b) end))',
  ...
  },
  {
    ...
    expected: {a: '1', b: '2', c: '3'},
    sample: 'local result = {}; for k, v in string.gmatch(s, "(%w+)=(%w+)") do result[k] = v end; return result',
  ...
  },
  {
    ...
    expected: ['1', '23', '456'],
    sample: 'local result = {}; for n in string.gmatch(s, "%d+") do table.insert(result, n) end; return result',
  ...
  },
  {
    ...
    expected: 12,
    sample: 'local function gcd(x, y) while y ~= 0 do x, y = y, x % y end; return x end; return (a * b) / gcd(a, b)',
  ...
  },
  {
    ...
    expected: true,
    sample: 'local log = math.log(n) / math.log(2); return math.abs(log - math.floor(log + 0.5)) < 0.0001',
  ...
  },
  {
    ...
    expected: true,
    sample: 'if n < 2 then return false end; for i = 2, math.sqrt(n) do if n % i == 0 then return false end end; return true',
  ...
  },
  {
    ...
    expected: 'missing_x',
    sample: 'setmetatable(t, {__index = function(tbl, key) return "missing_" .. key end}); return t.x',
  ...
  },
  {
    ...
    setupCode: 'local t = {}\nlocal overflow = {}',
    expected: 42,
    sample: 'setmetatable(t, {__newindex = function(tbl, key, val) overflow[key] = val end}); t.x = 42; return overflow.x',
  ...
  },
  {
    ...
    setupCode: 'local t = {1, 2, 3}',
    expected: 'Table(3)',
    sample: 'setmetatable(t, {__tostring = function(tbl) return "Table(" .. #tbl .. ")" end}); return tostring(t)',
  ...
  },
  {
    ...
    setupCode: 'local a = {1, 2, 3}\nlocal b = {4, 5, 6}',
    expected: [5, 7, 9],
    sample: 'local mt = {__add = function(t1, t2) local r = {}; for i = 1, #t1 do r[i] = t1[i] + t2[i] end; return r end}; setmetatable(a, mt); return a + b',
  ...
  },
  {
    ...
    expected: [9, 18, 27],
    sample: 'local mt = {__sub = function(t1, t2) local r = {}; for i = 1, #t1 do r[i] = t1[i] - t2[i] end; return r end}; setmetatable(a, mt); return a - b',
  ...
  },
  {
    ...
    setupCode: 'local t = {1, 2, 3}\nlocal scalar = 2',
    expected: [2, 4, 6],
    sample: 'local mt = {__mul = function(t1, n) local r = {}; for i = 1, #t1 do r[i] = t1[i] * n end; return r end}; setmetatable(t, mt); return t * scalar',
  ...
  },
  {
    ...
    setupCode: 'local t = {1, 2, 3}',
    expected: 6,
    sample: 'setmetatable(t, {__len = function(tbl) local count = 0; for _ in pairs(tbl) do count = count + 1 end; return count * 2 end}); return #t',
  ...
  },
  {
    ...
    setupCode: 'local t = {}',
    expected: 6,
    sample: 'setmetatable(t, {__call = function(tbl, a, b, c) return a + b + c end}); return t(1, 2, 3)',
  ...
  },
  {
    ...
    expected: true,
    sample: 'local mt = {__eq = function(t1, t2) return t1[1] == t2[1] end}; setmetatable(a, mt); setmetatable(b, mt); return a == b',
  ...
  },
  {
    ...
    expected: true,
    sample: 'local mt = {__lt = function(t1, t2) return #t1 < #t2 end}; setmetatable(a, mt); setmetatable(b, mt); return a < b',
  ...
  },
  {
    ...
    expected: 'a-b-c',
    sample: 'local mt = {__concat = function(tbl, s) return table.concat(tbl, s) end}; setmetatable(t, mt); return t .. sep',
  ...
  },
  {
    ...
    expected: 10,
    sample: 'local proxy = setmetatable({}, {__index = data, __newindex = function() error("read only") end}); return proxy.x',
  ...
  },
  {
    ...
    setupCode: 'local t = {1, 2, 3}',
    expected: [-1, -2, -3],
    sample: 'setmetatable(t, {__unm = function(tbl) local r = {}; for i, v in ipairs(tbl) do r[i] = -v end; return r end}); return -t',
  ...
  },
  {
    ...
    expected: [1, 2, 3],
    sample: 'setmetatable(t, {__div = function(tbl, n) local r = {}; for i, v in ipairs(tbl) do r[i] = v / n end; return r end}); return t / divisor',
  ...
  },
  {
    ...
    expected: 0,
    sample: 'setmetatable(t, {__index = function(tbl, key) if type(key) == "number" then return 0 end end}); return t[2]',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local function autotable() local mt = {__index = function(t, k) t[k] = setmetatable({}, getmetatable(t)); return t[k] end}; return setmetatable({}, mt) end; local t = autotable(); t.a.b.c = 42; return t.a.b.c',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [2, 8],
    sample: 'local function minmax(a, b) if a < b then return a, b else return b, a end end; local min, max = minmax(8, 2); return {min, max}',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 15,
    sample: 'local function sum(...) local total = 0; for _, v in ipairs({...}) do total = total + v end; return total end; return sum(1, 2, 3, 4, 5)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 3,
    sample: 'local function makeCounter() local count = 0; return function() count = count + 1; return count end end; local counter = makeCounter(); counter(); counter(); return counter()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 15,
    sample: 'local function multiplier(n) return function(x) return x * n end end; local triple = multiplier(3); return triple(5)',
  ...
  },
  {
    ...
    setupCode: 'local function addOne(x) return x + 1 end\nlocal function double(x) return x * 2 end',
    expected: 8,
    sample: 'local function compose(f, g) return function(x) return f(g(x)) end end; local addOneThenDouble = compose(double, addOne); return addOneThenDouble(3)',
  ...
  },
  {
    ...
    expected: 15,
    sample: 'local function partial(f, x) return function(y) return f(x, y) end end; local add10 = partial(add, 10); return add10(5)',
  ...
  },
  {
    ...
    setup: 'local callCount = 0\nlocal function expensive(n) callCount = callCount + 1; return n * n end',
    setupCode: 'local callCount = 0\nlocal function expensive(n) callCount = callCount + 1; return n * n end',
    expected: 1,
    sample: 'local function memoize(f) local cache = {}; return function(x) if cache[x] == nil then cache[x] = f(x) end; return cache[x] end end; local memo = memoize(expensive); memo(5); memo(5); memo(5); return callCount',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 8,
    sample: 'local function fib(n) if n <= 1 then return n end; return fib(n-1) + fib(n-2) end; return fib(6)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 120,
    sample: 'local function factorial(n, acc) acc = acc or 1; if n <= 1 then return acc end; return factorial(n - 1, n * acc) end; return factorial(5)',
  ...
  },
  {
    ...
    expected: [2, 4, 6],
    sample: 'local function filter(t, pred) local r = {}; for _, v in ipairs(t) do if pred(v) then table.insert(r, v) end end; return r end; return filter(nums, function(x) return x % 2 == 0 end)',
  ...
  },
  {
    ...
    expected: [1, 4, 9, 16],
    sample: 'local function map(t, f) local r = {}; for i, v in ipairs(t) do r[i] = f(v) end; return r end; return map(nums, function(x) return x * x end)',
  ...
  },
  {
    ...
    setupCode: 'local nums = {1, 2, 3, 4, 5}',
    expected: 15,
    sample: 'local function reduce(t, f, init) local acc = init; for _, v in ipairs(t) do acc = f(acc, v) end; return acc end; return reduce(nums, function(a, b) return a + b end, 0)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 5,
    sample: 'local function countArgs(...) return select("#", ...) end; return countArgs(1, 2, 3, 4, 5)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [30, 40, 50],
    sample: 'local function getFrom3(...) return {select(3, ...)} end; return getFrom3(10, 20, 30, 40, 50)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 6,
    sample: 'local function add(a) return function(b) return function(c) return a + b + c end end end; return add(1)(2)(3)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 2, 3, 4, 5],
    sample: 'local function range(n) local i = 0; return function() i = i + 1; if i <= n then return i end end end; local t = {}; for v in range(5) do table.insert(t, v) end; return t',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 4, 9, 16],
    sample: 'local function squares(max, current) current = current + 1; if current <= max then return current, current * current end end; local t = {}; for i, sq in squares, 4, 0 do t[i] = sq end; return t',
  ...
  },
  {
    ...
    setupCode: 'local s = "Lua"',
    expected: ['L', 'u', 'a'],
    sample: 'local function chars(str) local i = 0; return function() i = i + 1; if i <= #str then return string.sub(str, i, i) end end end; local t = {}; for c in chars(s) do table.insert(t, c) end; return t',
  ...
  },
  {
    ...
    expected: [5, 4, 3, 2, 1],
    sample: 'local function ripairs(t) local i = #t + 1; return function() i = i - 1; if i > 0 then return i, t[i] end end end; local r = {}; for _, v in ripairs(t) do table.insert(r, v) end; return r',
  ...
  },
  {
    ...
    expected: [2, 4, 6],
    sample: 'local function evens(t) local i = 0; return function() repeat i = i + 1 until i > #t or t[i] % 2 == 0; if i <= #t then return t[i] end end end; local r = {}; for v in evens(t) do table.insert(r, v) end; return r',
  ...
  },
  {
    ...
    setupCode: 'local a = {1, 2, 3}\nlocal b = {"a", "b", "c"}',
    expected: [[1, 'a'], [2, 'b'], [3, 'c']],
    sample: 'local function zip(t1, t2) local i = 0; return function() i = i + 1; if i <= #t1 and i <= #t2 then return {t1[i], t2[i]} end end end; local r = {}; for pair in zip(a, b) do table.insert(r, pair) end; return r',
  ...
  },
  {
    ...
    setupCode: 'local t = {"a", "b", "c"}',
    expected: [[1, 'a'], [2, 'b'], [3, 'c']],
    sample: 'local function enumerate(t) local i = 0; return function() i = i + 1; if i <= #t then return i, t[i] end end end; local r = {}; for idx, val in enumerate(t) do table.insert(r, {idx, val}) end; return r',
  ...
  },
  {
    ...
    expected: [1, 2, 3],
    sample: 'local function take(t, n) local i = 0; return function() i = i + 1; if i <= n and i <= #t then return t[i] end end end; local r = {}; for v in take(t, 3) do table.insert(r, v) end; return r',
  ...
  },
  {
    ...
    setupCode: 'local t = {1, 2, 3, 4, 5}',
    expected: [4, 5],
    sample: 'local function skip(t, n) local i = n; return function() i = i + 1; if i <= #t then return t[i] end end end; local r = {}; for v in skip(t, 3) do table.insert(r, v) end; return r',
...

  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local co = coroutine.create(function() return 42 end); local _, result = coroutine.resume(co); return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local co = coroutine.create(function() end); local ok = coroutine.resume(co); return ok',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'dead',
    sample: 'local co = coroutine.create(function() end); coroutine.resume(co); return coroutine.status(co)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 2, 3],
    sample: 'local co = coroutine.create(function() coroutine.yield(1); coroutine.yield(2); return 3 end); local r = {}; for i = 1, 3 do local _, v = coroutine.resume(co); table.insert(r, v) end; return r',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 10,
    sample: 'local co = coroutine.create(function(x) return x * 2 end); local _, result = coroutine.resume(co, 5); return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local co = coroutine.create(function() local x = coroutine.yield(); return x end); coroutine.resume(co); local _, result = coroutine.resume(co, 42); return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 2, 3],
    sample: 'local iter = coroutine.wrap(function() for i = 1, 3 do coroutine.yield(i) end end); local r = {}; for i = 1, 3 do table.insert(r, iter()) end; return r',
  ...
  },
  {
    ...
    sample: 'local function squares(n) return coroutine.wrap(function() for i = 1, n do coroutine.yield(i * i) end end) end; local r = {}; for sq in squares(5) do table.insert(r, sq) end; return r',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local co; co = coroutine.create(function() return coroutine.running() == co end); local _, result = coroutine.resume(co); return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 2, 3],
    sample: 'local results = {}; local producer = coroutine.create(function() for i = 1, 3 do coroutine.yield(i) end end); while coroutine.status(producer) ~= "dead" do local _, val = coroutine.resume(producer); if val then table.insert(results, val) end end; return results',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 1, 2, 3, 5],
    sample: 'local function fibgen() local a, b = 0, 1; while true do a, b = b, a + b; coroutine.yield(a) end end; local fib = coroutine.wrap(fibgen); local r = {}; for i = 1, 5 do table.insert(r, fib()) end; return r',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [2, 4, 6],
    sample: 'local function producer() for i = 1, 3 do coroutine.yield(i) end end; local function doubler(src) return function() local v = src(); if v then return v * 2 end end end; local p = coroutine.wrap(producer); local d = doubler(p); local r = {}; for i = 1, 3 do table.insert(r, d()) end; return r',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'done',
    sample: 'local task = coroutine.create(function() coroutine.yield("working"); return "done" end); coroutine.resume(task); local _, result = coroutine.resume(task); return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local co = coroutine.create(function() return coroutine.isyieldable() end); local _, result = coroutine.resume(co); return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 2, 3],
    sample: 'local co = coroutine.create(function() coroutine.yield(1, 2, 3) end); local _, a, b, c = coroutine.resume(co); return {a, b, c}',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'Value: 42',
    sample: 'local f = io.tmpfile(); f:write(string.format("Value: %d", 42)); f:seek("set"); return f:read("*a")',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 86400,
    sample: 'local t1 = os.time({year=2024, month=1, day=1}); local t2 = os.time({year=2024, month=1, day=2}); return os.difftime(t2, t1)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local t = os.date("*t", os.time({year=2024, month=1, day=1})); return t.wday >= 1 and t.wday <= 7',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local function test() return debug.getinfo(1) end; local info = test(); return info.what ~= nil',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local function test() return debug.getinfo(1, "l").currentline end; return type(test()) == "number"',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local function test() local x = 1; return debug.getlocal(1, 1) end; return test() ~= nil',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local function test() local x = 1; debug.setlocal(1, 1, 42); return x end; return test()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 10,
    sample: 'local x = 10; local function test() return x end; local _, val = debug.getupvalue(test, 1); return val',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local x = 10; local function test() return x end; debug.setupvalue(test, 1, 42); return test()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'Bob',
    sample: 'local obj = {name = "Bob"}; function obj:getName() return self.name end; return obj:getName()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'Carol',
    sample: 'local function Person(name) return {name = name} end; local p = Person("Carol"); return p.name',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'Hello',
    sample: 'local Class = {}; Class.__index = Class; function Class:greet() return "Hello" end; function Class.new() return setmetatable({}, Class) end; local obj = Class.new(); return obj:greet()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'Dave',
    sample: 'local Person = {}; Person.__index = Person; function Person.new(name) return setmetatable({name = name}, Person) end; function Person:getName() return self.name end; local p = Person.new("Dave"); return p:getName()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 30,
    sample: 'local Counter = {}; Counter.__index = Counter; function Counter.new() return setmetatable({value = 0}, Counter) end; function Counter:add(n) self.value = self.value + n end; function Counter:get() return self.value end; local c = Counter.new(); c:add(10); c:add(20); return c:get()',
  ...
  },
  {
    ...
    sample: 'local Animal = {}; Animal.__index = Animal; function Animal:speak() return "Animal speaks" end; local Dog = setmetatable({}, {__index = Animal}); Dog.__index = Dog; function Dog.new() return setmetatable({}, Dog) end; local d = Dog.new(); return d:speak()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'Woof',
    sample: 'local Animal = {}; Animal.__index = Animal; function Animal:speak() return "..." end; local Dog = setmetatable({}, {__index = Animal}); Dog.__index = Dog; function Dog:speak() return "Woof" end; function Dog.new() return setmetatable({}, Dog) end; local d = Dog.new(); return d:speak()',
  ...
  },
  {
    ...
    sample: 'local Animal = {}; Animal.__index = Animal; function Animal:speak(sound) return "Animal says: " .. sound end; local Dog = setmetatable({}, {__index = Animal}); Dog.__index = Dog; function Dog:speak() return Animal.speak(self, "Woof") end; function Dog.new() return setmetatable({}, Dog) end; local d = Dog.new(); return d:speak()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local function Counter() local count = 0; return {add = function(n) count = count + n end, get = function() return count end} end; local c = Counter(); c.add(42); return c.get()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'mixed in',
    sample: 'local Mixin = {mixed = function(self) return "mixed in" end}; local Class = {}; Class.__index = Class; for k, v in pairs(Mixin) do Class[k] = v end; function Class.new() return setmetatable({}, Class) end; local obj = Class.new(); return obj:mixed()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local Singleton = {}; local instance; function Singleton.getInstance() if not instance then instance = {data = 42} end; return instance end; local a = Singleton.getInstance(); local b = Singleton.getInstance(); return a == b',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 15,
    sample: 'local Builder = {}; Builder.__index = Builder; function Builder.new() return setmetatable({value = 0}, Builder) end; function Builder:add(n) self.value = self.value + n; return self end; function Builder:get() return self.value end; return Builder.new():add(5):add(10):get()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 2,
    sample: 'local Subject = {observers = {}, count = 0}; function Subject:subscribe(fn) table.insert(self.observers, fn) end; function Subject:notify() for _, fn in ipairs(self.observers) do fn() end end; Subject:subscribe(function() Subject.count = Subject.count + 1 end); Subject:subscribe(function() Subject.count = Subject.count + 1 end); Subject:notify(); return Subject.count',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local Class = {}; Class.__index = Class; function Class.new() return setmetatable({}, Class) end; local obj = Class.new(); return getmetatable(obj) == Class',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local packed = string.pack("i4", 42); local val = string.unpack("i4", packed); return val',
  ...
  },
  {
    ...
    expected: 2,
    sample: 'setmetatable(t, {__pairs = function(tbl) local keys = {"a", "b"}; local i = 0; return function() i = i + 1; if keys[i] then return keys[i], tbl[keys[i]] end end end}); local count = 0; for k in pairs(t) do count = count + 1 end; return count',
  ...
  },
  {
    ...
    setupCode: 'local t = {10, 20, 30}',
    expected: 3,
    sample: 'setmetatable(t, {__ipairs = function(tbl) local i = 0; return function() i = i + 1; if tbl[i] then return i, tbl[i] end end end}); local count = 0; for _ in ipairs(t) do count = count + 1 end; return count',
  ...
  },
  {
    ...
    setupCode: 'local a = {5}\nlocal b = {5}',
    expected: true,
    sample: 'local mt = {__le = function(t1, t2) return t1[1] <= t2[1] end}; setmetatable(a, mt); setmetatable(b, mt); return a <= b',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local mt = {__gc = function() end}; local t = setmetatable({}, mt); return getmetatable(t).__gc ~= nil',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [2, 4, 6],
    sample: 'local function apply(t, f) local r = {}; for i, v in ipairs(t) do r[i] = f(v) end; return r end; return apply({1, 2, 3}, function(x) return x * 2 end)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 25,
    sample: 'local function makeSquarer() return function(x) return x * x end end; local sq = makeSquarer(); return sq(5)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 10,
    sample: 'local function logged(f) return function(...) return f(...) end end; local function add(a, b) return a + b end; local loggedAdd = logged(add); return loggedAdd(4, 6)',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 42,
    sample: 'local function once(f) local called = false; local result; return function(...) if not called then called = true; result = f(...) end; return result end end; local init = once(function() return 42 end); init(); init(); return init()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 1,
    sample: 'local function throttle(f) local last = 0; return function(...) if os.clock() - last > 0 then last = os.clock(); return f(...) end end end; local count = 0; local inc = throttle(function() count = count + 1 end); inc(); return count',
  ...
  },
  {
    ...
    expected: 4,
    sample: 'local i = 0; local result; repeat i = i + 1; result = t[i] until result % 2 == 0; return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 12,
    sample: 'local result = 0; for i = 1, 3 do for j = 1, 4 do result = result + 1 end end; return result',
  ...
  },
  {
    ...
    setupCode: 'local t = {"a", "b", "c"}',
    expected: ['a', 'b', 'c', 'a', 'b'],
    sample: 'local function cycle(t, n) local i = 0; local count = 0; return function() if count >= n then return nil end; count = count + 1; i = (i % #t) + 1; return t[i] end end; local r = {}; for v in cycle(t, 5) do table.insert(r, v) end; return r',
  ...
  },
  {
    ...
    setupCode: 'local a = {1, 2}\nlocal b = {3, 4}',
    expected: [1, 2, 3, 4],
    sample: 'local function chain(t1, t2) local i = 0; local j = 0; return function() i = i + 1; if i <= #t1 then return t1[i] end; j = j + 1; if j <= #t2 then return t2[j] end end end; local r = {}; for v in chain(a, b) do table.insert(r, v) end; return r',
...

  {
    ...
    setupCode: '',
    expected: 'hello',
    sample: 'local co = coroutine.create(function() coroutine.yield("hello") end); local _, val = coroutine.resume(co); return val',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [1, 2, 3],
    sample: 'local function counter() local n = 0; while true do n = n + 1; coroutine.yield(n) end end; local co = coroutine.wrap(counter); local r = {}; for i = 1, 3 do table.insert(r, co()) end; return r',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 10,
    sample: 'local co = coroutine.create(function() local x = coroutine.yield(); return x * 2 end); coroutine.resume(co); local _, result = coroutine.resume(co, 5); return result',
  ...
  },
  {
    ...
    setupCode: '',
    expected: false,
    sample: 'local co = coroutine.create(function() error("oops") end); local ok = coroutine.resume(co); return ok',
  ...
  },
  {
    ...
    setupCode: '',
    expected: [2, 4, 6, 8, 10],
    sample: 'local function range(start, stop, step) return coroutine.wrap(function() for i = start, stop, step do coroutine.yield(i) end end) end; local r = {}; for v in range(2, 10, 2) do table.insert(r, v) end; return r',
...

  {
    ...
    setupCode: '',
    expected: 'test',
    sample: 'local obj = {name = "test"}; function obj:getName() return self.name end; return obj:getName()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 2,
    sample: 'local Class = {count = 0}; Class.__index = Class; function Class.new() Class.count = Class.count + 1; return setmetatable({}, Class) end; Class.new(); Class.new(); return Class.count',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 'cleaned',
    sample: 'local obj = {status = "active"}; function obj:destroy() self.status = "cleaned" end; obj:destroy(); return obj.status',
  ...
  },
  {
    ...
    sample: 'local Base = {}; Base.__index = Base; function Base:method() error("abstract") end; local Child = setmetatable({}, {__index = Base}); Child.__index = Child; function Child:method() return "implemented" end; function Child.new() return setmetatable({}, Child) end; return Child.new():method()',
  ...
  },
  {
    ...
    setupCode: '',
    expected: true,
    sample: 'local function implements(obj, interface) for k in pairs(interface) do if type(obj[k]) ~= "function" then return false end end; return true end; local obj = {speak = function() end, walk = function() end}; return implements(obj, {speak = true, walk = true})',
