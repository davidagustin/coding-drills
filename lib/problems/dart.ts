...
export const dartProblems: Problem[] = [
  ...
  },
  {
    ...
    setupCode: '',
    expected: 10,
    sample: 'var count = 0; for (var i = 1; i <= 20; i++) { if (i % 2 == 0) count++; } count;',
    hints: [
  ...
  {
    id: 'dart-beginner-loop-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Build String with For-In Loop',
    text: 'Use a for-in loop to concatenate all elements in a list ["H", "e", "l", "l", "o"] into a single string.',
    setup: 'var letters = ["H", "e", "l", "l", "o"];',
    setupCode: 'var letters = ["H", "e", "l", "l", "o"];',
    expected: 'Hello',
    sample: 'var result = ""; for (var letter in letters) { result += letter; } result;',
    hints: ['Use for-in to iterate over list elements', 'Use += for string concatenation'],
    tags: ['beginner', 'for-in', 'strings'],
  },
  {
    id: 'dart-beginner-loop-004',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    expected: 'positive',
    sample:
      'String result; if (num > 0) { result = "positive"; } else { result = "not positive"; } result;',
    hints: ['Use if-else with curly braces', 'Assign result to a variable'],
    tags: ['beginner', 'conditionals', 'if-else'],
  },
  {
    id: 'dart-beginner-cond-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    hints: ['Use condition ? trueValue : falseValue', 'Check even with modulo 2'],
    tags: ['beginner', 'conditionals', 'ternary'],
  },
  {
    id: 'dart-beginner-cond-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    expected: 'Tuesday',
    sample:
      'String result; switch (day) { case 1: result = "Monday"; break; case 2: result = "Tuesday"; break; case 3: result = "Wednesday"; break; default: result = "Unknown"; } result;',
    hints: ['Remember to use break after each case', 'Include a default case'],
    tags: ['beginner', 'conditionals', 'switch'],
  },
  {
    id: 'dart-beginner-list-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Add',
    text: 'Create a list with [1, 2, 3], add the number 4 to it, and return the list.',
    setup: '',
    setupCode: '',
    expected: [1, 2, 3, 4],
    sample: 'var list = [1, 2, 3]; list.add(4); list;',
    hints: ['Use add() to append elements', 'Lists are mutable by default in Dart'],
    tags: ['beginner', 'lists', 'add'],
  },
  {
    id: 'dart-beginner-list-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Access',
    text: 'Access the third element (index 2) of the list ["a", "b", "c", "d"].',
    setup: 'var list = ["a", "b", "c", "d"];',
    setupCode: 'var list = ["a", "b", "c", "d"];',
    expected: 'c',
    sample: 'list[2];',
  ...
  {
    id: 'dart-beginner-list-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Length',
    text: 'Return the length of the list [10, 20, 30, 40, 50].',
    setup: 'var list = [10, 20, 30, 40, 50];',
    setupCode: 'var list = [10, 20, 30, 40, 50];',
    expected: 5,
    sample: 'list.length;',
    hints: ['Use .length property', "It's a property, not a method"],
    tags: ['beginner', 'lists', 'length'],
  },
  {
    id: 'dart-beginner-map-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create a Map',
    ...
    setupCode: '',
    expected: 'Alice',
    sample: 'var map = {"name": "Alice"}; map["name"];',
    hints: ['Use {key: value} syntax', 'Access with map[key]'],
    tags: ['beginner', 'map', 'data-structures'],
  },
  {
    id: 'dart-beginner-map-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Map Keys',
  ...
  {
    id: 'dart-beginner-string-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'String Length',
    text: 'Return the length of the string "Dart is great".',
    setup: '',
    setupCode: '',
    expected: 13,
    sample: '"Dart is great".length;',
    hints: ['Use .length property', 'Spaces count as characters'],
    tags: ['beginner', 'string', 'length'],
  },
  {
    id: 'dart-beginner-while-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 4,
    sample: 'var count = 0; for (var a in [1,2]) { for (var b in [3,4]) { count++; } } count;',
    hints: [
      'Outer loop iterates first list',
      'Inner loop iterates second list for each outer element',
    ],
    tags: ['beginner', 'nested', 'for-loop'],
  },
  {
    id: 'dart-beginner-bool-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: '',
    expected: true,
    sample: 'var x = 10; x > 5 && x < 15;',
    hints: ['Use && for logical AND', 'Both conditions must be true'],
    tags: ['beginner', 'boolean', 'operators'],
  },
  {
    id: 'dart-beginner-list-adv-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Reduce for Max',
    text: 'Find the maximum value in the list [3, 7, 2, 9, 4] using reduce.',
    setup: '',
    setupCode: '',
    expected: 9,
    sample: '[3, 7, 2, 9, 4].reduce((a, b) => a > b ? a : b);',
    hints: ['Use .reduce() with a comparison function', 'Compare each pair and keep the larger'],
    tags: ['beginner', 'list', 'reduce', 'max'],
  },
  {
    id: 'dart-beginner-list-adv-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Contains',
    text: 'Check if the list [1, 2, 3, 4, 5] contains the value 3.',
    setup: '',
    setupCode: '',
    expected: true,
    sample: '[1, 2, 3, 4, 5].contains(3);',
