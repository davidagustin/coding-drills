...
export const goProblems: Problem[] = [
  ...
  // -- For Loops (4 problems) --
  {
    ...
    expected: '1 2 3 4 5',
    sample: 'for i := 1; i <= 5; i++ {\n    fmt.Print(i, " ")\n}',
    hints: [
      'Go only has for loops (no while or do-while)',
      'Use the traditional C-style for loop syntax',
    ],
    tags: ['for-loop', 'iteration', 'beginner'],
  },
  {
    id: 'go-beginner-loop-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: 'sum := 0',
    expected: 55,
    sample: 'for i := 1; i <= 10; i++ {\n    sum += i\n}',
    hints: ['Initialize sum to 0 before the loop', 'Add each number to sum inside the loop'],
    tags: ['for-loop', 'sum', 'beginner'],
  },
  {
    id: 'go-beginner-loop-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'While-Style For Loop',
    text: 'Write a for loop (as while) that counts down from 5 to 1',
    setup: 'count := 5',
    setupCode: 'count := 5',
    expected: '5 4 3 2 1',
    sample: 'for count >= 1 {\n    fmt.Print(count, " ")\n    count--\n}',
    hints: ['Go uses for with just a condition as a while loop', 'Omit init and post statements'],
    tags: ['for-loop', 'while', 'countdown', 'beginner'],
  },
  {
    id: 'go-beginner-loop-004',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Range Loop',
    text: 'Use a range loop to print all elements of a slice',
    setup: 'numbers := []int{10, 20, 30, 40, 50}',
    setupCode: 'numbers := []int{10, 20, 30, 40, 50}',
    expected: '10 20 30 40 50',
    sample: 'for _, num := range numbers {\n    fmt.Print(num, " ")\n}',
    hints: ['Range returns index and value', 'Use _ to ignore the index if not needed'],
    tags: ['range', 'slice', 'beginner'],
  },

  // -- Conditionals (3 problems) --
  {
    id: 'go-beginner-cond-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Basic If-Else',
  ...
  },
  {
    ...
    hints: ['Go switch does not need break statements', 'Cases do not fall through by default'],
    tags: ['switch', 'conditionals', 'beginner'],
  },

  // -- Slices (3 problems) --
  {
    id: 'go-beginner-slice-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create and Access Slice',
    text: 'Create a slice of 5 integers and access the third element',
    setup: '// Create slice and access element at index 2',
    setupCode: '// Create slice and access element at index 2',
    expected: 30,
    sample: 'nums := []int{10, 20, 30, 40, 50}\nthird := nums[2]',
    hints: ['Slice indices start at 0', 'Third element is at index 2'],
    tags: ['slice', 'access', 'beginner'],
  },
  {
    id: 'go-beginner-slice-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Slice Length',
    text: 'Get the length of a slice',
    setup: 'fruits := []string{"apple", "banana", "cherry", "date"}',
    setupCode: 'fruits := []string{"apple", "banana", "cherry", "date"}',
    expected: 4,
    sample: 'length := len(fruits)',
    hints: [
      'Use the len() function for slices',
      'Works for arrays, slices, maps, strings, and channels',
    ],
    tags: ['slice', 'len', 'beginner'],
  },
  {
    id: 'go-beginner-slice-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Find Maximum in Slice',
    text: 'Find the maximum value in an integer slice',
    ...
    tags: ['slice', 'max', 'iteration', 'beginner'],
  },

  // -- Maps (2 problems) --
  {
    id: 'go-beginner-map-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create and Add to Map',
    text: 'Create a map and add three key-value pairs',
    ...
    hints: [
      'Use make(map[KeyType]ValueType) to create a map',
      'Or use literal syntax: map[string]string{"key": "value"}',
    ],
    tags: ['map', 'make', 'beginner'],
  },
  {
    id: 'go-beginner-map-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Access Map Value',
    text: 'Create a map mapping names to ages and retrieve a value',
    setup: 'ages := map[string]int{"Alice": 25, "Bob": 30}',
    setupCode: 'ages := map[string]int{"Alice": 25, "Bob": 30}',
    expected: 25,
    sample: 'aliceAge := ages["Alice"]',
    hints: [
      'Use map[key] to access values',
      'Returns zero value if key does not exist',
      'Use value, ok := map[key] to check existence',
    ],
