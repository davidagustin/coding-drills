...
export const swiftProblems: Problem[] = [
  ...
  // ========================================
  {
    ...
    hints: ['Use 1...10 for closed range (inclusive)', 'Use var for mutable sum variable'],
    tags: ['beginner', 'for-loop', 'sum', 'range'],
  },
  {
    id: 'swift-beginner-loop-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: '',
    expected: 10,
    sample: 'var count = 0; for i in 1...20 { if i % 2 == 0 { count += 1 } }; count',
    hints: [
  ...
  {
    id: 'swift-beginner-loop-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Build String with Loop',
    text: 'Use a for loop to build the string "123456789" by concatenating numbers 1 through 9.',
    setup: '',
    setupCode: '',
    expected: '123456789',
    sample: 'var result = ""; for i in 1...9 { result += String(i) }; result',
    hints: ['Use String() to convert Int to String', 'Use += for string concatenation'],
    tags: ['beginner', 'for-loop', 'strings'],
  },
  {
    id: 'swift-beginner-loop-004',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    expected: 'positive',
    sample:
      'let result: String; if num > 0 { result = "positive" } else { result = "not positive" }; result',
    hints: ['Use if-else with curly braces', 'Assign result to a variable'],
    tags: ['beginner', 'conditionals', 'if-else'],
  },
  {
    id: 'swift-beginner-cond-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    expected: 'Tuesday',
    sample:
      'switch day { case 1: "Monday"; case 2: "Tuesday"; case 3: "Wednesday"; default: "Unknown" }',
    hints: ['Swift switch does not fall through by default', 'No break statement needed'],
    tags: ['beginner', 'conditionals', 'switch'],
  },
  {
    id: 'swift-beginner-array-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Append',
    text: 'Create an array with [1, 2, 3], append the number 4 to it, and return the array.',
    setup: '',
    setupCode: '',
    expected: [1, 2, 3, 4],
    sample: 'var arr = [1, 2, 3]; arr.append(4); arr',
    hints: ['Use var for mutable array', 'Use append() to add elements'],
    tags: ['beginner', 'arrays', 'append'],
  },
  {
    id: 'swift-beginner-array-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Access',
    text: 'Access the third element (index 2) of the array ["a", "b", "c", "d"].',
    setup: 'let arr = ["a", "b", "c", "d"]',
    setupCode: 'let arr = ["a", "b", "c", "d"]',
    expected: 'c',
    sample: 'arr[2]',
    hints: ['Arrays are zero-indexed', 'Use subscript notation arr[index]'],
    tags: ['beginner', 'arrays', 'indexing'],
  },
  {
    id: 'swift-beginner-array-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Count',
    text: 'Return the count of elements in the array [10, 20, 30, 40, 50].',
    setup: 'let arr = [10, 20, 30, 40, 50]',
    setupCode: 'let arr = [10, 20, 30, 40, 50]',
    expected: 5,
    sample: 'arr.count',
    hints: ['Use .count property', "It's a property, not a method"],
    tags: ['beginner', 'arrays', 'count'],
  },
  {
    id: 'swift-beginner-dict-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create a Dictionary',
    text: 'Create a dictionary with the key "name" set to "Alice", and return the value for "name".',
    setup: '',
    setupCode: '',
    expected: 'Alice',
    sample: 'let dict = ["name": "Alice"]; dict["name"]!',
    hints: ['Use [key: value] syntax', 'Dictionary access returns optional, use ! to unwrap'],
    tags: ['beginner', 'dictionary', 'data-structures'],
  },
  {
    id: 'swift-beginner-dict-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Dictionary Keys',
    text: 'Create a dictionary with keys "a", "b", "c" and values 1, 2, 3, then return all the keys sorted.',
    setup: '',
    setupCode: '',
    expected: ['a', 'b', 'c'],
    sample: 'let dict = ["a": 1, "b": 2, "c": 3]; Array(dict.keys).sorted()',
    hints: ['Use .keys property to get all keys', 'Convert to Array and sort for consistent order'],
    tags: ['beginner', 'dictionary', 'keys'],
  },
  {
    id: 'swift-beginner-string-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  {
    id: 'swift-beginner-string-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'String Count',
    text: 'Return the number of characters in the string "Swift is fun".',
    setup: '',
    setupCode: '',
    expected: 12,
    sample: '"Swift is fun".count',
    hints: ['Use .count property', 'Spaces count as characters'],
    tags: ['beginner', 'string', 'count'],
  },
  {
    id: 'swift-beginner-while-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  {
    id: 'swift-beginner-while-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Repeat-While Loop',
    text: 'Use a repeat-while loop to count from 1 to 3 and return the final count.',
    setup: '',
    setupCode: '',
    expected: 3,
    sample: 'var count = 0; repeat { count += 1 } while count < 3; count',
    hints: ['repeat-while executes at least once', 'Condition is checked after each iteration'],
    tags: ['beginner', 'repeat-while', 'loop'],
  },
  {
    id: 'swift-beginner-nested-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Nested For-In Loop',
    text: 'Use nested for-in loops to count all pairs from [1,2] and [3,4] (should be 4 pairs).',
    setup: '',
    setupCode: '',
    expected: 4,
    sample: 'var count = 0; for _ in [1,2] { for _ in [3,4] { count += 1 } }; count',
    hints: [
      'Outer loop iterates first array',
      'Inner loop iterates second array for each outer element',
    ],
    tags: ['beginner', 'nested', 'for-in', 'loop'],
  },
  {
    id: 'swift-beginner-bool-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    hints: ['Use .max() method', 'Returns optional, use ! to unwrap'],
    tags: ['beginner', 'array', 'max'],
  },
  {
    id: 'swift-beginner-arr-adv-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
