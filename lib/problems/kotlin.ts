...
export const kotlinProblems: Problem[] = [
  ...
  // ========================================
  {
    ...
    setupCode: '',
    expected: 55,
    sample: 'var sum = 0; for (i in 1..10) { sum += i }; sum',
    hints: ['Use 1..10 for range inclusive of both ends', 'Use var for mutable sum variable'],
    tags: ['beginner', 'for-loop', 'sum', 'range'],
  },
  {
    id: 'kt-beginner-loop-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: '',
    expected: 10,
    sample: 'var count = 0; for (i in 1..20) { if (i % 2 == 0) count++ }; count',
    hints: [
  ...
  {
    id: 'kt-beginner-loop-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Build String with Repeat',
    text: 'Use repeat to build a string with 5 asterisks "*****".',
    setup: '',
    setupCode: '',
    expected: '*****',
    sample: 'var result = ""; repeat(5) { result += "*" }; result',
    hints: ['repeat(n) executes the block n times', 'Concatenate to build the string'],
    tags: ['beginner', 'repeat', 'strings'],
  },
  {
    id: 'kt-beginner-loop-004',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: '',
    expected: 5,
    sample: 'var count = 0; while (count < 5) { count++ }; count',
    hints: ['Initialize count to 0', 'Loop while count is less than 5'],
    tags: ['beginner', 'while-loop'],
  },
  {
    id: 'kt-beginner-cond-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Simple If-Else',
    text: 'Write an if-else expression that returns "positive" if a number is greater than 0, otherwise "not positive".',
    setup: 'val num = 5',
    setupCode: 'val num = 5',
    expected: 'positive',
    sample: 'if (num > 0) "positive" else "not positive"',
    hints: ['if-else is an expression in Kotlin', 'No need for return keyword in expression form'],
    tags: ['beginner', 'conditionals', 'if-else'],
  },
  {
    id: 'kt-beginner-cond-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'When Expression Basic',
    text: 'Use a when expression to return the day name for a day number (1 = "Monday", 2 = "Tuesday", 3 = "Wednesday").',
    setup: 'val day = 2',
    setupCode: 'val day = 2',
    expected: 'Tuesday',
    sample: 'when (day) { 1 -> "Monday"; 2 -> "Tuesday"; 3 -> "Wednesday"; else -> "Unknown" }',
    hints: ["when is Kotlin's replacement for switch", 'Use -> to separate condition from result'],
    tags: ['beginner', 'conditionals', 'when'],
  },
  {
    id: 'kt-beginner-cond-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'When with Ranges',
    text: 'Use a when expression to return "A" for scores >= 90, "B" for >= 80, "C" for >= 70, otherwise "F".',
    setup: 'val score = 85',
    setupCode: 'val score = 85',
    expected: 'B',
    sample: 'when { score >= 90 -> "A"; score >= 80 -> "B"; score >= 70 -> "C"; else -> "F" }',
    hints: ['when without argument checks boolean conditions', 'Order matters - first match wins'],
    tags: ['beginner', 'conditionals', 'when'],
  },
  {
    id: 'kt-beginner-list-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create Mutable List and Add',
    text: 'Create a mutable list with [1, 2, 3], add the number 4 to it, and return the list.',
    setup: '',
    setupCode: '',
    expected: [1, 2, 3, 4],
    sample: 'val list = mutableListOf(1, 2, 3); list.add(4); list',
    hints: ['Use mutableListOf() for mutable lists', 'Use add() to append elements'],
    tags: ['beginner', 'lists', 'add'],
  },
  {
    id: 'kt-beginner-list-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Access',
    text: 'Access the third element (index 2) of the list listOf("a", "b", "c", "d").',
    setup: 'val list = listOf("a", "b", "c", "d")',
    setupCode: 'val list = listOf("a", "b", "c", "d")',
    expected: 'c',
    sample: 'list[2]',
    hints: ['Lists are zero-indexed', 'Use bracket notation list[index]'],
    tags: ['beginner', 'lists', 'indexing'],
  },
  {
    id: 'kt-beginner-list-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Size',
    text: 'Return the size of the list listOf(10, 20, 30, 40, 50).',
    setup: 'val list = listOf(10, 20, 30, 40, 50)',
    setupCode: 'val list = listOf(10, 20, 30, 40, 50)',
    expected: 5,
    sample: 'list.size',
    hints: ['Use .size property', "It's a property, not a method"],
    tags: ['beginner', 'lists', 'size'],
  },
  {
    id: 'kt-beginner-map-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create a Map',
    text: 'Create a map with the key "name" set to "Alice", and return the value for "name".',
    setup: '',
    setupCode: '',
    expected: 'Alice',
    sample: 'val map = mapOf("name" to "Alice"); map["name"]',
    hints: ['Use mapOf() with key to value syntax', 'Access with map[key]'],
    tags: ['beginner', 'map', 'data-structures'],
  },
  {
    id: 'kt-beginner-map-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Map Keys',
    text: 'Create a map with keys "a", "b", "c" and values 1, 2, 3, then return all the keys as a list.',
    setup: '',
    setupCode: '',
    expected: ['a', 'b', 'c'],
    sample: 'val map = mapOf("a" to 1, "b" to 2, "c" to 3); map.keys.toList()',
    hints: ['Use .keys property to get all keys', 'Convert to list with .toList()'],
    tags: ['beginner', 'map', 'keys'],
  },
  {
    id: 'kt-beginner-string-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  {
    id: 'kt-beginner-string-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'String Length',
    text: 'Return the length of the string "Kotlin rocks".',
    setup: '',
    setupCode: '',
    expected: 12,
    sample: '"Kotlin rocks".length',
    hints: ['Use .length property', 'Spaces count as characters'],
    tags: ['beginner', 'string', 'length'],
  },
  {
    id: 'kt-beginner-while-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 3,
    sample: 'var count = 0; do { count++ } while (count < 3); count',
    hints: ['do-while executes at least once', 'Condition is checked after each iteration'],
    tags: ['beginner', 'do-while', 'loop'],
  },
  {
    id: 'kt-beginner-nested-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Nested For Loop',
    text: 'Use nested for loops to count all pairs from 1..2 and 3..4 (should be 4 pairs).',
    setup: '',
    setupCode: '',
    expected: 4,
    sample: 'var count = 0; for (a in 1..2) { for (b in 3..4) { count++ } }; count',
    hints: [
      'Outer loop iterates first range',
      'Inner loop iterates second range for each outer element',
    ],
    tags: ['beginner', 'nested', 'for-loop'],
  },
  {
    id: 'kt-beginner-bool-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: '',
    expected: true,
    sample: 'val x = 10; x > 5 && x < 15',
    hints: ['Use && for logical AND', 'Both conditions must be true'],
    tags: ['beginner', 'boolean', 'operators'],
  },
  {
    id: 'kt-beginner-list-adv-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Max',
    text: 'Find the maximum value in the list listOf(3, 7, 2, 9, 4).',
    setup: '',
    setupCode: '',
    expected: 9,
    sample: 'listOf(3, 7, 2, 9, 4).max()',
    hints: ['Use .max() function', 'Returns the largest element'],
    tags: ['beginner', 'list', 'max'],
  },
  {
    id: 'kt-beginner-list-adv-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'List Contains',
    text: 'Check if the list listOf(1, 2, 3, 4, 5) contains the value 3.',
    setup: '',
    setupCode: '',
    expected: true,
    sample: 'listOf(1, 2, 3, 4, 5).contains(3)',
    hints: ['Use .contains() method', 'Returns true or false'],
