...
export const perlProblems: Problem[] = [
  ...
  // ========================================
  {
    ...
    setupCode: '',
    expected: 55,
    sample: 'my $sum = 0; for my $i (1..10) { $sum += $i; } $sum',
    hints: ['Initialize $sum to 0', 'Use 1..10 for range', 'Add each $i to $sum'],
    tags: ['beginner', 'for-loop', 'sum'],
  },
  {
    id: 'perl-beginner-loop-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    setupCode: '',
    expected: '123456789',
    sample: 'my $s = ""; for my $i (1..9) { $s .= $i; } $s',
    hints: ['Start with empty string', 'Use .= for concatenation', 'Loop from 1 to 9'],
    tags: ['beginner', 'for-loop', 'strings'],
  },
  {
    id: 'perl-beginner-cond-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Check Positive or Negative',
    text: 'Use if/elsif/else to return "positive" if number is greater than 0, "negative" if less than 0, or "zero".',
    setup: 'my $number = 5;',
    setupCode: 'my $number = 5;',
    expected: 'positive',
    sample: 'if ($number > 0) { "positive" } elsif ($number < 0) { "negative" } else { "zero" }',
    hints: ['Use if/elsif/else chain', 'Note: Perl uses elsif not elif', 'Check > 0 first'],
    tags: ['beginner', 'if-else', 'conditionals'],
  },
  {
    id: 'perl-beginner-cond-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Find Maximum of Two',
    text: 'Use if/else to return the larger of two numbers.',
    setup: 'my $a = 15; my $b = 8;',
    setupCode: 'my $a = 15; my $b = 8;',
    expected: 15,
    sample: 'if ($a > $b) { $a } else { $b }',
    hints: ['Compare $a and $b', 'Return larger value', 'Or use ternary: $a > $b ? $a : $b'],
    tags: ['beginner', 'if-else', 'comparison'],
  },
  {
    id: 'perl-beginner-cond-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Grade Calculator',
    text: 'Return letter grade: A for score >= 90, B for >= 80, C for >= 70, D for >= 60, F otherwise.',
    setup: 'my $score = 85;',
    setupCode: 'my $score = 85;',
    expected: 'B',
    sample:
      'if ($score >= 90) { "A" } elsif ($score >= 80) { "B" } elsif ($score >= 70) { "C" } elsif ($score >= 60) { "D" } else { "F" }',
    hints: ['Check from highest to lowest', 'Use if/elsif chain', 'Return grade letter'],
    tags: ['beginner', 'if-else', 'grades'],
  },
  {
    id: 'perl-beginner-array-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create and Sum Array',
    text: 'Create an array with values 1, 2, 3, 4, 5 and sum all elements using a loop.',
    setup: '',
    setupCode: '',
    expected: 15,
    sample: 'my @nums = (1, 2, 3, 4, 5); my $sum = 0; $sum += $_ for @nums; $sum',
    hints: ['Use @array for list', '$_ is default variable in for', 'Add each element to $sum'],
    tags: ['beginner', 'array', 'sum'],
  },
  {
    id: 'perl-beginner-array-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Push and Get Length',
    text: 'Create an array (10, 20), push 30, and return its length.',
    setup: '',
    setupCode: '',
    expected: 3,
    sample: 'my @arr = (10, 20); push @arr, 30; scalar @arr',
    hints: ['Use push to add element', 'scalar @arr gives length', 'Or use $#arr + 1'],
    tags: ['beginner', 'array', 'push', 'length'],
  },
  {
    id: 'perl-beginner-hash-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create and Access Hash',
    text: 'Create a hash with key "apple" => 3 and return the value for "apple".',
    setup: '',
    setupCode: '',
    expected: 3,
    sample: 'my %h = (apple => 3); $h{apple}',
    hints: ['Use %hash for hashes', 'Use => for key-value pairs', 'Access with $hash{key}'],
    tags: ['beginner', 'hash', 'access'],
  },
  {
    id: 'perl-beginner-hash-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Count Hash Entries',
    text: 'Create a hash with 3 fruit entries and return the number of keys.',
    setup: '',
    setupCode: '',
    expected: 3,
    sample: 'my %h = (apple => 1, banana => 2, cherry => 3); scalar keys %h',
    hints: ['Create hash with multiple pairs', 'Use keys %h for key list', 'scalar gives count'],
    tags: ['beginner', 'hash', 'keys', 'length'],
  },
];
