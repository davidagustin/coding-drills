...
export const perlProblems: Problem[] = [
  ...
  {
    id: 'perl-beginner-string-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'String Concatenation',
    text: 'Concatenate "Hello, " and "World!" using the dot operator.',
    setup: '',
    setupCode: '',
    expected: 'Hello, World!',
    sample: '"Hello, " . "World!"',
    hints: ['Use . operator for concatenation', 'Works with variables too', '.= appends in place'],
    tags: ['beginner', 'string', 'concatenation'],
  },
  {
    id: 'perl-beginner-string-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'String Length',
    text: 'Return the length of the string "Perl".',
    setup: '',
    setupCode: '',
    expected: 4,
    sample: 'length("Perl")',
    hints: ['Use length() function', 'Returns number of characters', 'Works on variables too'],
    tags: ['beginner', 'string', 'length'],
  },
  {
    id: 'perl-beginner-while-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: '',
    expected: 15,
    sample: 'my $sum = 0; my $i = 1; while ($i <= 5) { $sum += $i; $i++; } $sum',
    hints: [
  ...
  {
    id: 'perl-beginner-array-adv-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Sort',
    text: 'Sort the array (5, 2, 8, 1, 9) in ascending numeric order and return the first element.',
    setup: '',
    setupCode: '',
    expected: 1,
    sample: 'my @arr = (5, 2, 8, 1, 9); my @sorted = sort { $a <=> $b } @arr; $sorted[0]',
    hints: ['Use sort with comparison block', '$a <=> $b for numeric sort', 'cmp for string sort'],
    tags: ['beginner', 'array', 'sort'],
  },
  {
    id: 'perl-beginner-array-adv-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Grep Filter',
    text: 'Use grep to filter (1, 2, 3, 4, 5, 6) and keep only even numbers. Return the count.',
    setup: '',
    setupCode: '',
    expected: 3,
    sample: 'my @arr = (1, 2, 3, 4, 5, 6); my @even = grep { $_ % 2 == 0 } @arr; scalar @even',
    hints: ['grep filters with condition', '$_ is current element', 'Returns matching elements'],
    tags: ['beginner', 'array', 'grep', 'filter'],
  },
  {
    id: 'perl-beginner-hash-adv-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Hash Exists',
    text: 'Check if key "banana" exists in hash (apple => 1, banana => 2, cherry => 3).',
    setup: '',
    setupCode: '',
    expected: 1,
    sample: 'my %h = (apple => 1, banana => 2, cherry => 3); exists $h{banana} ? 1 : 0',
    hints: ['Use exists() function', 'Returns true if key exists', 'Different from checking value'],
    tags: ['beginner', 'hash', 'exists'],
  },
];
