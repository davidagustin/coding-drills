...
export const mysqlProblems: Problem[] = [
  ...
  },
  {
    ...
    setup: 'Table: employees (id INT, name VARCHAR(50), salary DECIMAL(10,2))',
    setupCode:
      "CREATE TABLE employees (id INT, name VARCHAR(50), salary DECIMAL(10,2));\nINSERT INTO employees VALUES (1, 'Charlie', 60000), (2, 'Alice', 75000), (3, 'Bob', 55000);",
  ...
  },
  {
    ...
    setup: 'Table: employees (id INT, name VARCHAR(50), salary DECIMAL(10,2))',
    setupCode:
      "CREATE TABLE employees (id INT, name VARCHAR(50), salary DECIMAL(10,2));\nINSERT INTO employees VALUES (1, 'Alice', 75000), (2, 'Bob', 55000), (3, 'Carol', 90000);",
  ...
  {
    id: 'mysql-beginner-limit-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Basic LIMIT',
    text: 'Select the first 3 employees from the table.',
    setup: 'Table: employees (id INT, name VARCHAR(50))',
    setupCode:
      "CREATE TABLE employees (id INT, name VARCHAR(50));\nINSERT INTO employees VALUES (1, 'Alice'), (2, 'Bob'), (3, 'Carol'), (4, 'David'), (5, 'Eve');",
  ...
  },
  {
    ...
    setup: 'Table: employees (id INT, name VARCHAR(50))',
    setupCode:
      "CREATE TABLE employees (id INT, name VARCHAR(50));\nINSERT INTO employees VALUES (1, 'Alice'), (2, 'Bob'), (3, 'Carol'), (4, 'David'), (5, 'Eve'), (6, 'Frank');",
    ...
    validPatterns: [
      /SELECT\s+\*\s+FROM\s+employees\s+LIMIT\s+3\s+OFFSET\s+3/i,
      /SELECT\s+\*\s+FROM\s+employees\s+LIMIT\s+3\s*,\s*3/i,
    ],
    tags: ['select', 'beginner', 'limit', 'offset', 'pagination'],
  },
  {
    id: 'mysql-beginner-count-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setup: 'Table: employees (id INT, name VARCHAR(50), department VARCHAR(50))',
    setupCode:
      "CREATE TABLE employees (id INT, name VARCHAR(50), department VARCHAR(50));\nINSERT INTO employees VALUES (1, 'Alice', 'Engineering'), (2, 'Bob', 'Sales'), (3, 'Carol', 'Engineering');",
    expected: '3',
