...
export const rubyProblems: Problem[] = [
  ...
  // ========================================
  {
    id: 'rb-beginner-loop-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Sum Numbers with Times',
    text: 'Use the times method to sum all numbers from 1 to 10.',
    setup: '',
    setupCode: '',
    expected: 55,
    sample: 'sum = 0; 10.times { |i| sum += i + 1 }; sum',
    hints: ['times iterates from 0 to n-1', 'Add i + 1 to get 1 through 10'],
    tags: ['beginner', 'times', 'loop', 'sum'],
  },
  {
    id: 'rb-beginner-loop-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Count Even Numbers with Each',
    text: 'Use each to count how many even numbers are in the range 1 to 20.',
    setup: '',
    setupCode: '',
    expected: 10,
    sample: 'count = 0; (1..20).each { |n| count += 1 if n.even? }; count',
    hints: ['Use (1..20) for range', 'Use .even? to check for even numbers'],
    tags: ['beginner', 'each', 'loop', 'conditionals'],
  },
  {
    id: 'rb-beginner-loop-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Build String with Upto',
    text: 'Use upto to build the string "123456789" by concatenating numbers 1 through 9.',
    setup: '',
    setupCode: '',
    expected: '123456789',
    sample: 'result = ""; 1.upto(9) { |n| result += n.to_s }; result',
    hints: ['upto iterates from start to end inclusive', 'Convert numbers to strings with to_s'],
    tags: ['beginner', 'upto', 'loop', 'strings'],
  },
  {
    id: 'rb-beginner-loop-004',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    setupCode: 'num = 5',
    expected: 'positive',
    sample: 'if num > 0 then "positive" else "not positive" end',
    hints: ['Use if...else...end syntax', 'The last expression in each branch is returned'],
    tags: ['beginner', 'conditionals', 'if-else'],
  },
  {
    id: 'rb-beginner-cond-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: 'num = 8',
    expected: 'even',
    sample: 'num.even? ? "even" : "odd"',
    hints: [
      'Ruby has a ternary operator: condition ? true_value : false_value',
      'Use .even? method to check',
    ],
    tags: ['beginner', 'conditionals', 'ternary'],
  },
  {
    id: 'rb-beginner-cond-003',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Case Statement',
    text: 'Use a case statement to return the day name for a day number (1 = "Monday", 2 = "Tuesday", 3 = "Wednesday").',
    setup: 'day = 2',
    setupCode: 'day = 2',
    expected: 'Tuesday',
    sample:
      'case day when 1 then "Monday" when 2 then "Tuesday" when 3 then "Wednesday" else "Unknown" end',
    hints: ['Use case...when...else...end syntax', 'No break statement needed in Ruby'],
    tags: ['beginner', 'conditionals', 'case'],
  },
  {
    id: 'rb-beginner-array-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Push',
    ...
    setupCode: '',
    expected: [1, 2, 3, 4],
    sample: 'arr = [1, 2, 3]; arr.push(4); arr',
    hints: ['Use push or << to add elements', 'push modifies the array in place'],
    tags: ['beginner', 'arrays', 'push'],
  },
  {
    id: 'rb-beginner-array-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Access',
  ...
  },
  {
    ...
    expected: 5,
    sample: 'arr.length',
    hints: ['Use .length or .size method', 'Both return the same result in Ruby'],
    tags: ['beginner', 'arrays', 'length'],
  },
  {
    id: 'rb-beginner-hash-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Create a Hash',
    text: 'Create a hash with the key :name set to "Alice", and return the value for :name.',
    setup: '',
    setupCode: '',
    expected: 'Alice',
    sample: 'hash = { name: "Alice" }; hash[:name]',
    hints: ['Use { key: value } syntax for symbol keys', 'Access with hash[:key]'],
    tags: ['beginner', 'hash', 'data-structures'],
  },
  {
    id: 'rb-beginner-hash-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Hash Keys',
    text: 'Create a hash with keys :a, :b, :c and values 1, 2, 3, then return all the keys.',
    setup: '',
    setupCode: '',
    expected: ['a', 'b', 'c'],
    sample: 'hash = { a: 1, b: 2, c: 3 }; hash.keys',
    hints: ['Use .keys method to get all keys', 'Returns an array of keys'],
    tags: ['beginner', 'hash', 'keys'],
  },
  {
    id: 'rb-beginner-string-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  {
    id: 'rb-beginner-string-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'String Length',
    text: 'Return the length of the string "Ruby is fun".',
    setup: '',
    setupCode: '',
    expected: 11,
    sample: '"Ruby is fun".length',
    hints: ['Use .length or .size method', 'Spaces count as characters'],
    tags: ['beginner', 'string', 'length'],
  },
  {
    id: 'rb-beginner-while-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    ...
    setupCode: '',
    expected: 15,
    sample: 'sum = 0; i = 1; while i <= 5 do sum += i; i += 1 end; sum',
    hints: ['Initialize sum and counter variables', 'Increment counter inside the loop'],
    tags: ['beginner', 'while', 'loop', 'sum'],
  },
  {
    id: 'rb-beginner-while-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Until Loop',
    text: 'Use an until loop to count down from 5 to 1 and return the final count.',
    setup: '',
    setupCode: '',
    expected: 0,
    sample: 'count = 5; until count == 0 do count -= 1 end; count',
    hints: ['until is the opposite of while', 'Loop until condition becomes true'],
    tags: ['beginner', 'until', 'loop'],
  },
  {
    id: 'rb-beginner-nested-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Nested Each Loop',
    text: 'Use nested each loops to count all pairs from [1,2] and [3,4] (should be 4 pairs).',
    setup: '',
    setupCode: '',
    expected: 4,
    sample: 'count = 0; [1,2].each { |a| [3,4].each { |b| count += 1 } }; count',
    hints: [
      'Outer loop iterates first array',
      'Inner loop iterates second array for each outer element',
    ],
    tags: ['beginner', 'nested', 'each', 'loop'],
  },
  {
    id: 'rb-beginner-bool-001',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
  ...
  },
  {
    ...
    setupCode: '',
    expected: 9,
    sample: '[3, 7, 2, 9, 4].max',
    hints: ['Use .max method', 'Returns the largest element'],
    tags: ['beginner', 'array', 'max'],
  },
  {
    id: 'rb-beginner-arr-adv-002',
    category: 'Beginner Fundamentals',
    difficulty: 'easy',
    title: 'Array Include?',
    text: 'Check if the array [1, 2, 3, 4, 5] includes the value 3.',
    setup: '',
    setupCode: '',
    expected: true,
    sample: '[1, 2, 3, 4, 5].include?(3)',
    hints: ['Use .include? method', 'Returns true or false'],
    tags: ['beginner', 'array', 'include'],
  },
];
