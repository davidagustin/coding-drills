...
export const rubyProblems: Problem[] = [
  ...
  // reduce / inject
  {
    ...
    hints: ['reduce accumulates a value', 'Start with 0 as initial value'],
    validPatterns: [
  ...
  },
  {
    ...
    hints: ['inject is an alias for reduce', 'Start with 1 for multiplication'],
    validPatterns: [
  ...
  // split / join
  {
    ...
    hints: ['split breaks string at delimiter'],
    validPatterns: [
  ...
  // chars / bytes
  {
    ...
    expected: ['r', 'u', 'b', 'y'],
    sample: 'text.chars',
    hints: ['chars returns array of individual characters'],
    validPatterns: [
      /text\.chars\b/,
      /text\.split\s*\(\s*["']['"]?\s*\)/,
    ],
  ...
  // keys / values
  {
    ...
    sample: 'person.keys',
    hints: ['keys returns an array of all keys'],
    validPatterns: [
      /person\.keys\b/,
    ],
    tags: ['keys', 'hash'],
