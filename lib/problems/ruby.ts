...
export const rubyProblems: Problem[] = [
  ...
  },
  {
    ...
    setup: 'nums = { a: 1, b: 2, c: 3, d: 4 }',
    setupCode: 'nums = { a: 1, b: 2, c: 3, d: 4 }',
    expected: { false: [["a", 1], ["c", 3]], true: [["b", 2], ["d", 4]] },
  ...
  },
  {
    ...
    sample: 'm = text.match(/(?<year>\\d{4})-(?<month>\\d{2})-(?<day>\\d{2})/); { year: m[:year], month: m[:month], day: m[:day] }',
  ...
  },
  {
    ...
    setupCode: 'people = [{name: "Bob", age: 30}, {name: "Alice", age: 25}, {name: "Alice", age: 30}]',
    expected: [{name: 'Alice', age: 25}, {name: 'Alice', age: 30}, {name: 'Bob', age: 30}],
  ...
  },
  {
    ...
    setup: 'module Loud; def speak; super.upcase; end; end\nclass Dog; prepend Loud; def speak; "woof"; end; end',
    setupCode: 'module Loud; def speak; super.upcase; end; end\nclass Dog; prepend Loud; def speak; "woof"; end; end',
    expected: 'WOOF',
  ...
  },
  {
    ...
    expected: true,
    sample: 'r1 = Ractor.new { 1 }; r2 = Ractor.new { 2 }; Ractor.select(r1, r2).first.is_a?(Ractor)',
  ...
  },
  {
    ...
    setup: 'Address = Struct.new(:city)\nPerson = Struct.new(:name, :address)\np = Person.new("Alice", Address.new("NYC"))',
    setupCode: 'Address = Struct.new(:city)\nPerson = Struct.new(:name, :address)\np = Person.new("Alice", Address.new("NYC"))',
    expected: 'NYC',
  ...
  },
  {
    ...
    setup: 'class Box; include Comparable; attr_reader :size; def initialize(s); @size = s; end; def <=>(other); size <=> other.size; end; end',
    setupCode: 'class Box; include Comparable; attr_reader :size; def initialize(s); @size = s; end; def <=>(other); size <=> other.size; end; end',
    expected: true,
  ...
  },
  {
    ...
    setup: 'class MyCollection; include Enumerable; def initialize(arr); @arr = arr; end; def each(&block); @arr.each(&block); end; end',
    setupCode: 'class MyCollection; include Enumerable; def initialize(arr); @arr = arr; end; def each(&block); @arr.each(&block); end; end',
    expected: [2, 4, 6],
