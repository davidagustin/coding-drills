...
export const dartCheatsheet: CheatsheetEntry[] = [
  // ============ LIST (ARRAYS) METHODS ============
  {
    name: 'add / addAll',
    category: 'arrays',
    syntax: 'list.add(element) / list.addAll(iterable)',
    description: 'Adds element(s) to the end of the list',
    example: {
      code: 'var nums = [1, 2];\nnums.add(3);\nnums.addAll([4, 5]);\nprint(nums);',
      output: '[1, 2, 3, 4, 5]',
    },
    timeComplexity: 'O(1) for add, O(n) for addAll',
    spaceComplexity: 'O(1)',
  ...
  {
    name: 'remove / removeAt',
    category: 'arrays',
    syntax: 'list.remove(element) / list.removeAt(index)',
    description: 'Removes first occurrence of element or element at index',
    example: {
    ...
    timeComplexity: 'O(n)',
    spaceComplexity: 'O(1)',
    gotchas: ['remove returns bool', 'removeAt returns the removed element'],
    priority: 'essential',
  },
  {
    name: 'removeLast',
  ...
  {
    name: 'isEmpty / isNotEmpty / length',
    category: 'arrays',
    syntax: 'list.isEmpty / list.isNotEmpty / list.length',
    description: 'Checks if list is empty or gets its length',
    example: {
  ...
  },
  {
    name: 'every / any',
    category: 'functional',
    syntax: 'iterable.every((e) => cond) / iterable.any((e) => cond)',
    description: 'Checks if all/any elements satisfy the condition',
    example: {
    ...
    timeComplexity: 'O(n)',
    spaceComplexity: 'O(1)',
    gotchas: ['Both short-circuit on first conclusive result'],
    priority: 'common',
  },
  {
    name: 'firstWhere',
  ...
  {
    name: 'indexOf / lastIndexOf (String)',
    category: 'strings',
  ...
  },
  {
    name: 'trim',
    category: 'strings',
    syntax: 'str.trim() / str.trimLeft() / str.trimRight()',
  ...
  {
    name: 'codeUnitAt / String.fromCharCode',
    category: 'strings',
    syntax: 'str.codeUnitAt(index) / String.fromCharCode(code)',
    description: 'Gets UTF-16 code unit or creates string from code',
    example: {
  ...
  },
  {
    ...
    example: {
      code: "var map = {'a': 1, 'b': 2};\nprint(map.keys.toList());\nfor (var e in map.entries) print(e.key + ':' + e.value.toString());",
      output: '[a, b]\na:1\nb:2',
    },
  ...
  },
  {
    ...
    category: 'iteration',
    syntax: 'list.asMap()',
    description: 'Returns map with indices as keys for index-based iteration',
    example: {
