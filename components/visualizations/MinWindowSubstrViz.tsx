    ...
    <div className="w-full rounded-2xl bg-zinc-900 border border-zinc-800 p-6 space-y-6">
      ...
      <div className="text-center space-y-1">
        ...
        <p className="text-sm text-zinc-400">
          Find smallest window containing all chars from &quot;{T}&quot;
        </p>
      </div>
      ...
      <div className="flex justify-center gap-6 text-xs">
        ...
        <div className="flex items-center gap-1.5">
          <span
            ...
            style={{ background: COLORS.required }}
          />
            ...
            {currentStep.minWindow && (
              <div className="flex items-start gap-2">
                ...
                <span className="text-zinc-300 font-bold" style={{ color: COLORS.min }}>
                  &quot;
                  {S.substring(
                    currentStep.minWindow.start,
                    currentStep.minWindow.start + currentStep.minWindow.length,
                  )}
                  &quot; (length {currentStep.minWindow.length})
                </span>
              </div>
            )}
          </>
