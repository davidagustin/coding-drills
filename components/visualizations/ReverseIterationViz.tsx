...
function computeSteps(): ReverseStep[] {
  ...
  steps.push({
    ...
    result: [],
    i: -1,
    explanation: `Start: Reverse iterate through array [${ARRAY.join(', ')}]`,
  });
...
export default function ReverseIterationViz() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-zinc-900 rounded-xl border border-zinc-800">
      <h2 className="text-2xl font-bold text-white mb-4">Reverse Array Iteration</h2>
