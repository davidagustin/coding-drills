  ...
  const cellData = useMemo(() => {
    ...
    return chars.map((char, index) => {
      ...
      if (
        ...
        currentStep.lastSeen.get(char)! >= currentStep.start
      ) {
        status = 'duplicate';
      }
  ...
  return (
    <div className="w-full rounded-2xl bg-zinc-900 border border-zinc-800 p-6 space-y-6">
      ...
      <div className="flex justify-center gap-6 text-xs">
        ...
        <div className="flex items-center gap-1.5">
          <span className="inline-block w-3 h-3 rounded-sm" style={{ background: COLORS.duplicate }} />
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-zinc-300">
                {currentStep.end >= currentStep.start
                  ? currentStep.end - currentStep.start + 1
                  : 0}
              </span>
            </div>
            <div className="flex items-start gap-2">
