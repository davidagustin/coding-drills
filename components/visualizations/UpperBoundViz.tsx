...
function computeSteps(): UpperBoundStep[] {
  const steps: UpperBoundStep[] = [];
  let lo = 0;
  let hi = ARRAY.length;
  ...
  steps.push({
    ...
    hi,
    mid: -1,
    explanation: `Start: Find upper bound (first index > ${TARGET})`,
  });
  ...
  steps.push({
    ...
    hi,
    mid: -1,
    explanation: `Complete: Upper bound = ${lo}`,
  });
...
export default function UpperBoundViz() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-zinc-900 rounded-xl border border-zinc-800">
      <h2 className="text-2xl font-bold text-white mb-4">Upper Bound (Binary Search)</h2>
