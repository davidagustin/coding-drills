          ...
          {current === null ? (
            ...
            <>
              ...
              <div className="flex justify-center gap-4 text-xs text-zinc-400">
                <span>
                  Water at position: <span className="text-white font-semibold">{current.waterAtCurrent}</span>
                </span>
                <span>
                  Total Water: <span className="text-white font-semibold">{current.totalWater}</span>
                </span>
              </div>
            </>
          )}
