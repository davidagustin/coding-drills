...
function computeSteps(): ComposeStep[] {
  ...
  steps.push({
    ...
    currentFn: -1,
    value,
    explanation: `Start: compose(add1, mul2, sub3)(${INPUT})`,
  });
...
export default function ComposeFunctionsViz() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-zinc-900 rounded-xl border border-zinc-800">
      <h2 className="text-2xl font-bold text-white mb-4">Compose Functions</h2>
      ...
      <div className="space-y-6">
        {/* Functions */}
        <div>
          <h3 className="text-sm font-medium text-zinc-400 mb-2">Functions (Right-to-Left)</h3>
