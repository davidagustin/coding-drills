...
function computeSteps(): Combination2Step[] {
...
export default function CombinationSum2Viz() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 bg-zinc-900 rounded-xl border border-zinc-800">
      <h2 className="text-2xl font-bold text-white mb-4">Combination Sum II (No Duplicates)</h2>
      ...
      <div className="mb-6 space-y-6">
        <div>
          <h3 className="text-lg font-semibold text-zinc-300 mb-3">Candidates (Sorted)</h3>
