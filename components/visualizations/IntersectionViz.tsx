...
function computeSteps(): IntersectionStep[] {
  ...
  steps.push({
    ...
    i: -1,
    phase: 'build-set',
    explanation: `Start: Find elements in both arrays`,
  });
  ...
  for (let i = 0; i < ARRAY1.length; i++) {
    ...
    if (inSet) {
      ...
      steps.push({
        ...
        i,
        phase: 'filter',
        explanation: `Index ${i}: ${val} in Set → add to result`,
      });
    } else {
      steps.push({
        arr1: [...ARRAY1],
        ...
        i,
        phase: 'filter',
        explanation: `Index ${i}: ${val} not in Set → skip`,
      });
    }
  }
    ...
    <div className="w-full max-w-4xl mx-auto p-6 bg-zinc-900 rounded-xl border border-zinc-800">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <h3 className="text-sm font-medium text-zinc-400 mb-2">Array 2 (Set)</h3>
            <div className="flex gap-2 flex-wrap">
              {arr2.map((val, idx) => (
                <div
                  key={idx}
        ...
        {/* Result Array */}
        <div>
          <h3 className="text-sm font-medium text-zinc-400 mb-2">Result Array (Common Elements)</h3>
          <div className="flex gap-2 flex-wrap">
            {result.length === 0 ? (
