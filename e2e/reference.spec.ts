...
test.describe('Reference Page - Page Load', () => {
  ...
  test('should display all methods', async ({ page }) => {
    ...
    const methodsList = page.locator('[data-testid="methods-list"]').or(
      page.locator('.methods-list').or(
        page.locator('ul, ol').filter({ has: page.locator('[data-testid="method-item"]') })
      )
    );
    ...
    const methodItems = page.locator('[data-testid="method-item"]').or(
      page.locator('.method-item').or(
        page.locator('[data-testid="method-card"]').or(
          page.locator('article').filter({ hasText: /\.\w+\(|function|method/i })
        )
      )
    );
  ...
  test('should display search bar', async ({ page }) => {
    const searchBar = page.locator('[data-testid="search-input"]').or(
  ...
  test('should display category filters', async ({ page }) => {
    const categoryFilters = page.locator('[data-testid="category-filter"]').or(
      page.locator('[data-testid="category-filters"]').or(
  ...
  test('should display method names', async ({ page }) => {
    ...
    const methodNames = page.locator('text=/\\.(map|filter|reduce|forEach|find|some|every|includes|slice|concat|join|split|push|pop|shift|indexOf)/');
...
test.describe('Reference Page - Search Functionality', () => {
  ...
  test('should filter methods when typing in search', async ({ page }) => {
    ...
    const methodItems = page.locator('[data-testid="method-item"]').or(
      page.locator('.method-item').or(
        page.locator('[data-testid="method-card"]')
      )
    );
  ...
  test('should show no results message when nothing matches', async ({ page }) => {
    ...
    const noResultsMessage = page.locator('[data-testid="no-results"]').or(
      page.locator('text=/no (results|methods|matches)|not found|nothing found/i')
    );
...
test.describe('Reference Page - Category Filtering', () => {
  ...
  test('should filter by category when clicking category filter', async ({ page }) => {
    ...
    const arrayFilter = page.locator('[data-testid="category-filter-array"]').or(
      page.locator('button').filter({ hasText: /^array$/i }).or(
        page.locator('[role="tab"]').filter({ hasText: /array/i })
      )
    );
    ...
    if (await arrayFilter.first().isVisible()) {
      ...
      const categoryIndicator = page.locator('[data-testid="active-category"]').or(
        page.locator('.active-category').or(
      ...
      expect(
        await categoryIndicator.first().isVisible().catch(() => false) ||
  ...
  test('should show multiple categories can be combined', async ({ page }) => {
    ...
    const categoryFilters = page.locator('[data-testid^="category-filter"]').or(
      page.locator('button').filter({ hasText: /^(array|string|object)$/i })
    );
  ...
  test('should have "All" option that shows everything', async ({ page }) => {
    const allFilter = page.locator('[data-testid="category-filter-all"]').or(
      page.locator('button').filter({ hasText: /^all$/i }).or(
        page.locator('[role="tab"]').filter({ hasText: /^all$/i })
      )
    );

    if (await allFilter.first().isVisible()) {
      // First filter by a category
      const categoryFilter = page.locator('[data-testid^="category-filter-"]').not(allFilter).first();
  ...
  test('should show category labels on methods', async ({ page }) => {
    ...
    const categoryBadges = page.locator('[data-testid="method-category"]').or(
      page.locator('.category-badge').or(
        page.locator('.method-category').or(
          page.locator('span, badge').filter({ hasText: /array|string|object|number/i })
        )
      )
    );
...
test.describe('Reference Page - Method Details', () => {
  ...
  test('should expand method details on click', async ({ page }) => {
    // Find a method item
    const methodItem = page.locator('[data-testid="method-item"]').or(
      page.locator('.method-item').or(
        page.locator('[data-testid="method-card"]').or(
          page.locator('button, [role="button"], details').filter({ hasText: /\.\w+\(/ })
        )
      )
    ).first();
    ...
    const methodDetails = page.locator('[data-testid="method-details"]').or(
      page.locator('.method-details').or(
        page.locator('[data-testid="method-expanded"]').or(
          page.locator('text=/syntax|description|arguments|example/i')
        )
      )
    );
  ...
  test('should show syntax in method details', async ({ page }) => {
    ...
    const syntax = page.locator('[data-testid="method-syntax"]').or(
      page.locator('.method-syntax').or(
        page.locator('code, pre').filter({ hasText: /\.\w+\s*\(/ })
      )
    );
  ...
  test('should show description in method details', async ({ page }) => {
    ...
    const description = page.locator('[data-testid="method-description"]').or(
      page.locator('.method-description').or(
        page.locator('p').filter({ hasText: /.{20,}/ })
      )
    );
  ...
  test('should show arguments in method details', async ({ page }) => {
    ...
    const arguments_ = page.locator('[data-testid="method-arguments"]').or(
      page.locator('.method-arguments').or(
        page.locator('text=/arguments|parameters|params/i')
      )
    );
  ...
  test('should show examples in method details', async ({ page }) => {
    ...
    const examples = page.locator('[data-testid="method-examples"]').or(
      page.locator('.method-examples').or(
        page.locator('text=/example/i')
      )
    );
  ...
  test('should display example code correctly', async ({ page }) => {
    ...
    const exampleCode = page.locator('[data-testid="example-code"]').or(
      page.locator('.example-code').or(
  ...
  test('should be able to collapse method details', async ({ page }) => {
    ...
    const expandedDetails = page.locator('[data-testid="method-details"]:visible').or(
      page.locator('.method-details:visible')
    );

    // Either details are hidden or the element has collapsed state
    const isCollapsed = await expandedDetails.count() === 0 ||
  ...
  test('should show return value information', async ({ page }) => {
    ...
    const returnValue = page.locator('[data-testid="method-returns"]').or(
      page.locator('.method-returns').or(
        page.locator('text=/returns?|return value/i')
      )
    );
...
test.describe('Reference Page - Navigation', () => {
  ...
  test('should have quick nav / jump to section', async ({ page }) => {
    ...
    const quickNav = page.locator('[data-testid="quick-nav"]').or(
      page.locator('.quick-nav').or(
        page.locator('nav').filter({ hasText: /jump|quick|contents|sections/i }).or(
          page.locator('[role="navigation"]').filter({ has: page.locator('a[href^="#"]') })
        )
      )
    );

    // Quick nav might exist or page might use other navigation
    const hasQuickNav = await quickNav.first().isVisible().catch(() => false);
  ...
  test('should have back link to language page', async ({ page }) => {
    ...
    const backLink = page.locator('[data-testid="back-link"]').or(
      page.locator('a').filter({ hasText: /back|javascript|home/i }).or(
        page.locator('a[href*="javascript"]').not(page.locator('a[href*="reference"]'))
      )
    );
    ...
    await expect(page).not.toHaveURL(new RegExp('/reference'));
  });
  ...
  test('should have breadcrumb navigation', async ({ page }) => {
    ...
    const breadcrumb = page.locator('[data-testid="breadcrumb"]').or(
      page.locator('.breadcrumb').or(
        page.locator('nav[aria-label="breadcrumb"]').or(
          page.locator('text=/home.*javascript.*reference|javascript.*>.*reference/i')
        )
      )
    );
  ...
  test('should scroll to top on category change', async ({ page }) => {
    ...
    const categoryFilter = page.locator('[data-testid^="category-filter"]').or(
      page.locator('button').filter({ hasText: /^(array|string)$/i })
    ).first();
...
test.describe('Reference Page - Accessibility', () => {
  ...
  test('should have proper ARIA labels', async ({ page }) => {
    ...
    if (await searchInput.first().isVisible()) {
      ...
      const label = await page.locator(`label[for="${await searchInput.first().getAttribute('id')}"]`).count();
...
test.describe('Reference Page - Cross-Language Support', () => {
  ...
  for (const lang of languages) {
    test(`should load reference page for ${lang}`, async ({ page }) => {
      ...
      const methodItems = page.locator('[data-testid="method-item"]').or(
        page.locator('.method-item').or(
          page.locator('article, .method-card')
        )
      );
